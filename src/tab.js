  ...
  autoPlay() {
    ...
    this.state.setTimer = setInterval(() => {
      ...
      setTimeout(() => {
        this.setState({
          w: 10,
          transitions: this.props.tabJson.timer / 100,
        });
      }, 0.2);
    ...
    return (
      ...
      >
        <div
          className="line"
          style={{
            transition: "all " + this.state.transitions + "s",
            width: this.state.w + "%",
          }}
        ></div>
        ...
        <ul
          style={{
            width: this.props.tabJson.picUrl.length * 0.2 + "px",
            left: -this.state.index * 0.2 + "px",
          }}
        >
          {oLi}
        </ul>
